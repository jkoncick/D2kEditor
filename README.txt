...
Step 1)
Extract ALL files and folders into some local folder on your computer. 
...
- If you copy the editor into some folder under your Dune 2000 game folder, program
  should configure itself automatically and you will be able to use it right away.
- Otherwise program will prompt you upon start and offer you to navigate to game
  location manually.

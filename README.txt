...
- If you copy the editor into some folder under your Dune 2000 game folder, program
  should detect that and you will be able to use it right away.
...
- 4 MB disk space
- 64 MB RAM
- Screen resolution at least 1280*720 pixels
...
- You can create and design your own new tileset. You need to provide configuration .ini
  file and special attributes .BIN file which will contain additional editor attributes
  (use TileAtrEditor to create one) and put them under tilesets folder. You can use
  template.ini as a base of your new configuration.

...
type
  TUnitTemplate = packed record
    ...
    HealthBarSize:              byte;
    PrimaryWeaponShootOffset:   shortint;
    Flags:                      cardinal;
    ...
    PrimaryWeaponBulkShots:     byte;
    PrimaryWeaponShortDelay:    byte;
    PrimaryWeaponDoubleShot:    byte;
    PrimaryWeaponNoAutoAttack:  byte;
    PrimaryWeaponShootAngle:    byte;
    SecondaryWeaponBulkShots:   byte;
    SecondaryWeaponShortDelay:  byte;
    SecondaryWeaponLongDelay:   byte;

...
const DEFENCE_AREAS_END_BYTE = DEFENCE_AREAS_START_BYTE + DEFENCE_AREA_SIZE * CNT_DEFENCE_AREAS;
const BUILD_RATIO_START_BYTE = 5836;
const MAX_BUILDINGS_START_BYTE = 6236;
const BUILD_RATIO_MAX_BUILDINGS_END_BYTE = 6636;
